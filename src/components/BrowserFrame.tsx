  ...
  return (
    <div className={cn('overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm', className)}>
      <div className="flex items-center gap-3 border-b border-gray-200 bg-gray-50 px-4 py-2.5">
        ...
        <div className="flex min-w-0 flex-1 items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-1 font-mono text-xs text-gray-600">
          <SiteAddress />
          <span className="truncate text-gray-400">{path}</span>
        </div>
      </div>
